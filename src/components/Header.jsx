...
const Header = ({ openCart, hasCartItems, cart, isCartOpen, removeFromCart }) => {
    ...
    return (
        <>
            <header className='flex relative items-center p-5 justify-between lg:p-8 lg:border-b-2'>
                <span className='flex ml-10 lg:ml-0 lg:gap-16'>
                    <img className='w-36' src='./images/logo.svg' />
                    <NavBar />
                </span>
                <span className='flex basis-1/5 justify-between items-center lg:justify-end lg:gap-8'>
                    ...
                    <img className='w-6 lg:w-12' src='./images/image-avatar.png' alt='profile picture' />
                </span>
            </header>
        </>
    );
